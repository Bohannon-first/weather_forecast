...
const arrayCities = ['Москва', 'Санкт-Петербург', 'Стокгольм', 'Стамбул', 'Париж', 'Лондон', 'Рейкьявик', 'Пекин', 'Токио', 'Берлин', 'Сидней', 'Нью-Йорк', 'Чикаго', 'Лос-Анджелес', 'Бангкок', 'Пхукет', 'Паттайя'];
